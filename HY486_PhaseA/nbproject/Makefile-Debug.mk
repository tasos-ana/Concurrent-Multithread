...
${OBJECTDIR}/stack_lazySync/list.o: stack_lazySync/list.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stack_lazySync/list.o stack_lazySync/list.c

${OBJECTDIR}/stack_lazySync/stack.o: stack_lazySync/stack.c
	${MKDIR} -p ${OBJECTDIR}/stack_lazySync
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stack_lazySync/stack.o stack_lazySync/stack.c
