...
${OBJECTDIR}/ListFGSync/listFGSync.o: ListFGSync/listFGSync.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListFGSync/listFGSync.o ListFGSync/listFGSync.c

${OBJECTDIR}/ListLazySync/listLazySync.o: ListLazySync/listLazySync.c
	${MKDIR} -p ${OBJECTDIR}/ListLazySync
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListLazySync/listLazySync.o ListLazySync/listLazySync.c

${OBJECTDIR}/StackCG/stackCG.o: StackCG/stackCG.c
	${MKDIR} -p ${OBJECTDIR}/StackCG
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StackCG/stackCG.o StackCG/stackCG.c

${OBJECTDIR}/StackCGWithElim/stackCGWithElim.o: StackCGWithElim/stackCGWithElim.c
	${MKDIR} -p ${OBJECTDIR}/StackCGWithElim
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StackCGWithElim/stackCGWithElim.o StackCGWithElim/stackCGWithElim.c
...
${OBJECTDIR}/source/client.o: source/client.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/client.o source/client.c

${OBJECTDIR}/source/list.o: source/list.c
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/list.o source/list.c

${OBJECTDIR}/source/stack.o: source/stack.c
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/stack.o source/stack.c

${OBJECTDIR}/source/updater.o: source/updater.c
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/updater.o source/updater.c

${OBJECTDIR}/source/utils.o: source/utils.c
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/utils.o source/utils.c
